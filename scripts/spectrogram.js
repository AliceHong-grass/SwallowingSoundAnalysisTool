(function(root) {
  ...
  function Spectrogram(canvas, options) {
    if (!(this instanceof Spectrogram)) return new Spectrogram(canvas);
    ...
    this._baseCanvas.width = this._baseCanvas.width;
    this._baseCanvas.height =this._baseCanvas.height;
  }
